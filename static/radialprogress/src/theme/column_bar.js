...
vizuly.theme.column_bar = function (viz) {
    ...
    function applyTheme() {
        ...
        if (viz.layout() == vizuly.component.layout.STACKED) {
    ...
    //Vizuly components come packaged with the themes you see here, but there is no reason you can't create your own.
    ...
    // the intrinsic object id and class names of a vizuly component.
    //
    //To learn more about modifying and building your own vizuly components, read our guide **<a href=''>Customizing Vizuly Components</a>**.
}
