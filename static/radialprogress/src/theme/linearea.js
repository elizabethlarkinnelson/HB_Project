...
vizuly.theme.linearea = function (viz) {
    ...
    function onMeasure() {
        viz.yAxis().tickSize(-vizuly.util.size(viz.margin(), viz.width(), viz.height()).width).ticks(5).orient("left");
        viz.xAxis().tickSize(-vizuly.util.size(viz.margin(), viz.width(), viz.height()).width);
    }
    ...
    var skins = {
        ...
        Ocean: {
            ...
            area_fill_opacity: function (d, i) {
                return ((i+1)/viz.data().length) * ((this.layout() == vizuly.component.layout.OVERLAP) ?  0.8 : 0.85);
            },
            xAxis_font_weight: 200,
            yAxis_line_stroke: "#FFF",
            yAxis_line_opacity: .25,
        ...
        Neon : {
            ...
            area_fill_opacity: function (d, i) {
                return ((i+1)/this.data().length) * ((this.layout() == vizuly.component.layout.OVERLAP) ?  0.6 : 0.8);
            },
            xAxis_font_weight: 200,
            yAxis_line_stroke: "#FFF",
            yAxis_line_opacity: .25,
        ...
        Business : {
            ...
            area_fill_opacity: function (d, i) {
                return ((this.layout() == vizuly.component.layout.OVERLAP) ? 0.8 : 0.9);
            },
            xAxis_font_weight: 200,
