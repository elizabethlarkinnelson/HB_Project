...
vizuly.theme.radial_linearea = function (viz) {
    ...
    function onMeasure() {
        ...
        viz.yAxis().tickSize(viz.outerRadius()).ticks( (viz.layout() == vizuly.component.layout.OVERLAP) ? 5 : 7).orient("left");
    }
    ...
    var skins = {
        ...
        Neon : {
            ...
            area_fill_opacity: function (d, i) {
                ...
                return (this.layout() == vizuly.component.layout.OVERLAP ?  p *.8 : p);
            },
            xAxis_font_weight: 200,
            yAxis_line_stroke: "#FFF",
            yAxis_line_opacity: .25,
        ...
        Business : {
            ...
            area_fill_opacity: function (d, i) {
                return ((this.layout() == vizuly.component.layout.OVERLAP) ? 0.9 : 0.95);
            },
            xAxis_font_weight: 200,
